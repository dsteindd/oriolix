...
export class Logout extends Component<IProps, IState> {
    ...
    async processLogoutCallback() {
        ...
        switch (result.status) {
            ...
            case AuthenticationResultStatus.Success:
                await this.navigateToReturnUrl(this.getReturnUrl((result as { state: any }).state));
                break;
            case AuthenticationResultStatus.Fail:
                this.setState({message: (result as { message: string }).message});
                break;
            default:
                throw new Error("Invalid authentication result status.");
        }
    ...
    getReturnUrl(state?: { returnUrl: string }): string {
