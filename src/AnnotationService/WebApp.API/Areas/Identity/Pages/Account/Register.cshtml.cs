...
public class RegisterModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            user.ToSAccepted = Input.ToSAccepted;
            ...
            if (result.Succeeded)
            {
                ...
                _logger.LogInformation("User assigned to role 'User'");
    ...
    public class InputModel
    {
        ...
        [Required]
        [CheckboxRequired(ErrorMessage = "You must accept the Terms of Service to register.")]
